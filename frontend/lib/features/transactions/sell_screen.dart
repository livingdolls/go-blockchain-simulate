...
///
/// Flow:
/// 1. User isi address (seller) dan amount
/// 2. Generate nonce
/// 3. Tampilkan pesan canonical: " SELL {amount} nonce:{nonce}"
/// 4. User paste signature
/// 5. Submit ke backend
...
class _SellScreenState extends State<SellScreen> {
  ...
  Future<void> _generateNonce() async {
    ...
    try {
      ...
      final msg = TransactionHelper.buildSellMessage(
        amount: amount,
        nonce: nonce,
      );
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      final result = await _txHelper.sellTransaction(
      ...
      setState(() {
        _success = result['message'] as String? ??
            'Sell order berhasil dikirim dan sedang diproses';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Jual YTE')),
      body: ListView(
                ...
                children: [
                  Text(
                    _isSigningMode
                        ...
                        : 'Langkah 1: Isi detail penjualan',
                  ...
                  TextFormField(
                    ...
                    decoration: const InputDecoration(
                      labelText: 'Wallet Address (Seller)',
                      hintText: '0x...',
                  ...
                  TextFormField(
                    ...
                    decoration: const InputDecoration(
                      labelText: 'Jumlah YTE yang ingin dijual',
                      hintText: '3.0',
